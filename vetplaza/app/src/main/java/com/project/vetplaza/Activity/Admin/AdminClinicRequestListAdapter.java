...
public class AdminClinicRequestListAdapter extends FirebaseRecyclerAdapter<ClinicData, AdminClinicRequestListAdapter.PastViewHolder> {
    private OnShareClickedListener mCallback;
    private Context mContext;
    private  ViewGroup parent;

    public AdminClinicRequestListAdapter(@NonNull FirebaseRecyclerOptions<ClinicData> options, Context context) {
        super(options);
        mContext = context;
    }
